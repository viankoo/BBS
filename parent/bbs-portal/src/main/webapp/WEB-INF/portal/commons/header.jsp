...
function serachKeyword(sort,pageNum){
	/* 搜索应该接用户的搜索条件，整理以价格排序为例 */
	window.location.href = "/search?keyword=" + $("#keyword").val()+"&brandId=${brandId}&pa=${pa}&pb=${pb}&sort="+sort+"&pageNum="+pageNum+"&pageSize=6";
}
</script>
<!--shortcut start-->
...
<div id="o-header-2013">
	<input type="hidden" id="noSort" value="${sort0 }">
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<div class="form">
					...
					<input type="button" value="搜索" class="button" onclick="serachKeyword('${sort0}',1)" >
				</div>
			</div>
			<div id="hotwords"></div>
		</div>
